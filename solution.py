                            ...
                            def addData():
                                ...
                                def write():
                                    ...
                                    if (z1 == "") or (z2 == "") or (z3 == "") or (z4 == "") or (z5 == ""):
                                        ...
                                        s.starttls() 
                                        s.login("yashdubeywinner@gmail.com", "yasharth")
                                        s.sendmail("yashdubeywinner@gmail.com",z3,"Your transaction is succesful and the id will be sent to you,Thanks for deposit")
